...
| [compression-engine](./compression-engine) | From-scratch data compression engine: Huffman, LZ77, BWT+MTF+RLE, DEFLATE-like (LZ77+static Huffman), bit-level I/O, canonical Huffman codes, CLI (compress/decompress/benchmark), 65 tests |
