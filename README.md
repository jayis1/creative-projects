...
| [bplus-db](./bplus-db) | B+ Tree database engine: range queries, prefix scans, ACID-like transactions, WAL, bulk loading, merge/diff, JSON/binary persistence, SQL-like query language, tree validation, CLI, 112 tests |
