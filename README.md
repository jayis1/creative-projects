...
| [circuit-simulator](./circuit-simulator) | Digital circuit simulator: 10 gate types, 5 sequential elements (SR/D/JK/T latches & flip-flops), clocks, propagation delays, 4-valued signals, buses, composite builders (half/full adder, ripple-carry, MUX, decoder), event-driven simulator, CDL parser, oscilloscope with ASCII waveforms & VCD export, 59 tests |
