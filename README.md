...
| [waveform-synth](./waveform-synth) | From-scratch digital audio synthesizer: 7 waveform types, pulse oscillator, ADSR envelopes, FM synthesis with 5 presets, 9 effects (reverb, compressor, delay, flanger, distortion, LP/HP, tremolo, gain), stereo processing, YIN pitch detection, spectral analysis, WAV read/write (8/16/24/32-bit), composition engine, note/scale/chord library, ASCII visualization, CLI, 95 tests |
