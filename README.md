...
| [cryptanalysis-toolkit](./cryptanalysis-toolkit) | Classical cipher toolkit: 10 ciphers (Caesar, substitution, Vigenère, affine, Playfair, rail fence, columnar transposition, autokey, Beaufort, Porta), frequency analysis, IC, Kasiski examination, n-gram scoring, automatic breaking (Caesar/affine/Vigenère/substitution), hill climbing, CLI, 89 tests |
