...
| [midi-sequencer](./midi-sequencer) | Generative MIDI step sequencer: Euclidean/Markov/random pattern generation, 15 scales, 11 chord types, drum patterns, humanization, chord progressions, multi-track song assembly, MIDI export |
